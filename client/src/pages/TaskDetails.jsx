...
const TaskDetails = () => {
    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row gap-6 sm:p-4 text-foreground max-w-6xl mx-auto">
                ...
                {project && (
                    <Card>
                        <CardContent className="p-4">
                            ...
                            <h2 className="flex items-center gap-2 font-medium"> <PenIcon className="h-4 w-4" /> {project.name}</h2>
